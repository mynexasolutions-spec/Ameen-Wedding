...
const PHONE_DISPLAY = "+91 93905 62826";
const PHONE_TEL = "+919390562826";
const PHONE_WA = "919390562826";
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[60] flex flex-col items-end gap-3.5">
      ...
      >
        ...
        <span className="relative flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-full bg-gold text-white shadow-lg shadow-gold/30 ring-1 ring-white/40 transition-all duration-300 group-hover:bg-gold-dark group-hover:scale-110 group-hover:shadow-xl group-hover:shadow-gold/40">
      ...
      >
        ...
        <span className="relative flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-[#25D366]/40 ring-1 ring-white/40 transition-all duration-300 group-hover:bg-[#1fb956] group-hover:scale-110 group-hover:shadow-xl">
